...
function columnToSchema(column, factory) {
    var _factory_zodInstance;
    const z$1 = (_factory_zodInstance = factory === null || factory === void 0 ? void 0 : factory.zodInstance) !== null && _factory_zodInstance !== void 0 ? _factory_zodInstance : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"];
    var _factory_coerce;
    const coerce = (_factory_coerce = factory === null || factory === void 0 ? void 0 : factory.coerce) !== null && _factory_coerce !== void 0 ? _factory_coerce : {};
    let schema;
...
function numberColumnToSchema(column, z, coerce) {
    ...
    let schema = coerce === true || (coerce === null || coerce === void 0 ? void 0 : coerce.number) ? z.coerce.number() : z.number();
...
function bigintColumnToSchema(column, z, coerce) {
    ...
    const schema = coerce === true || (coerce === null || coerce === void 0 ? void 0 : coerce.bigint) ? z.coerce.bigint() : z.bigint();
...
function stringColumnToSchema(column, z, coerce) {
    ...
    if (isColumnType(column, [
        ...
        var _column_length;
        max = (_column_length = column.length) !== null && _column_length !== void 0 ? _column_length : CONSTANTS.INT16_UNSIGNED_MAX;
    } else if (isColumnType(column, [
        'MySqlText',
        'SingleStoreText'
    ])) {
    ...
    let schema = coerce === true || (coerce === null || coerce === void 0 ? void 0 : coerce.string) ? z.coerce.string() : z.string();
...
function handleColumns(columns, refinements, conditions, factory) {
    ...
    for (const [key, selected] of Object.entries(columns)){
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$entity$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["is"])(selected, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$column$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Column"]) && !(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$entity$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["is"])(selected, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$sql$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SQL"]) && !(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$entity$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["is"])(selected, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$sql$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SQL"].Aliased) && typeof selected === 'object') {
            ...
            var _refinements_key;
            columnSchemas[key] = handleColumns(columns, (_refinements_key = refinements[key]) !== null && _refinements_key !== void 0 ? _refinements_key : {}, conditions, factory);
            continue;
        }
...
function handleEnum(enum_, factory) {
    var _factory_zodInstance;
    const zod = (_factory_zodInstance = factory === null || factory === void 0 ? void 0 : factory.zodInstance) !== null && _factory_zodInstance !== void 0 ? _factory_zodInstance : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"];
...
const insertConditions = {
    never: (column)=>{
        var _column_generated, _column_generatedIdentity;
        return (column === null || column === void 0 ? void 0 : (_column_generated = column.generated) === null || _column_generated === void 0 ? void 0 : _column_generated.type) === 'always' || (column === null || column === void 0 ? void 0 : (_column_generatedIdentity = column.generatedIdentity) === null || _column_generatedIdentity === void 0 ? void 0 : _column_generatedIdentity.type) === 'always';
    },
...
const createSelectSchema = (entity, refine)=>{
    ...
    return handleColumns(columns, refine !== null && refine !== void 0 ? refine : {}, selectConditions);
};
const createInsertSchema = (entity, refine)=>{
    const columns = getColumns(entity);
    return handleColumns(columns, refine !== null && refine !== void 0 ? refine : {}, insertConditions);
};
const createUpdateSchema = (entity, refine)=>{
    const columns = getColumns(entity);
    return handleColumns(columns, refine !== null && refine !== void 0 ? refine : {}, updateConditions);
};
function createSchemaFactory(options) {
    const createSelectSchema = (entity, refine)=>{
        ...
        const columns = getColumns(entity);
        return handleColumns(columns, refine !== null && refine !== void 0 ? refine : {}, selectConditions, options);
    };
    const createInsertSchema = (entity, refine)=>{
        const columns = getColumns(entity);
        return handleColumns(columns, refine !== null && refine !== void 0 ? refine : {}, insertConditions, options);
    };
    const createUpdateSchema = (entity, refine)=>{
        const columns = getColumns(entity);
        return handleColumns(columns, refine !== null && refine !== void 0 ? refine : {}, updateConditions, options);
    };
    return {
        createSelectSchema,
        createInsertSchema,
...
//# sourceMappingURL=node_modules_f074e2ed._.js.map