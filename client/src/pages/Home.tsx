      ...
      <main>
        ...
        <section className="py-24 bg-white text-black overflow-hidden">
          <div className="container mx-auto px-4 md:px-6 mb-12">
            <h2 className="text-4xl font-bold font-display text-center md:text-left">Our Expertise</h2>
          </div>
          
          <div className="flex flex-wrap justify-center md:justify-start gap-4 md:gap-8 container mx-auto px-4 md:px-6">
